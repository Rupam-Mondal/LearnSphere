    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 p-6 text-center">
        <div className="bg-white p-10 rounded-3xl shadow-xl border border-slate-100 flex flex-col items-center">
          ...
          <button
            onClick={() => navigate(-1)}
            className="mt-6 px-6 py-2 cursor-pointer bg-slate-900 text-white rounded-xl"
          >
            Go Back
          </button>
        </div>
    ...
    <div className="min-h-screen bg-slate-50/50 pb-20">
      <nav className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-slate-200 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center cursor-pointer gap-2 text-slate-600 hover:text-indigo-600 transition"
          >
            <ArrowLeft size={20} />{" "}
            ...
            <div className="flex flex-col gap-3">
              {details.approved !== "approved" ? (
                <button
                  ...
                  className="w-full cursor-pointer py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-2xl font-bold transition flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="w-full cursor-pointer py-3 bg-yellow-500 hover:bg-yellow-600 text-white rounded-2xl font-bold transition flex items-center justify-center gap-2"
                >
              ...
              <button
                ...
                className="w-full cursor-pointer py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-2xl font-bold transition flex items-center justify-center gap-2"
              >
                <XCircle size={18} /> Reject
              </button>
              <button
                onClick={() => updateTeacherStatus("banned")}
                className="w-full cursor-pointer py-3 bg-white border border-red-200 hover:bg-red-50 text-red-600 rounded-2xl font-bold transition flex items-center justify-center gap-2"
              >
